...
let input_list_compartments: object[] =
  input_converter.get_backpack_list_compartments(input);
let input_list_for_groups: object[][] =
  input_converter.get_backpack_list_for_groups(input);
